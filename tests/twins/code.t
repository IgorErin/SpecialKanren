  ...
  let twins is = conde [ (twin (!! false) (!! false) is); (twin (!! false) (!! false) is); (twin (!! false) (!! false) is); ]
  ...
  let rec twin_false_false_false = failwith "Reduced"
  and twin_false_false_false = failwith "Reduced"
  and twin_false_false_false = failwith "Reduced"
  and twin_false_false_true = failwith "Reduced"
  and twin_false_false_true = failwith "Reduced"
  and twin_false_false_true = failwith "Reduced"
