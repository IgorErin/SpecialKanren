  ...
  let rec is_even_false n = Fresh.one (fun not_res -> Fresh.one (fun pred_n -> (n === (!! (S (pred_n)))) &&& ((not_res === (!! true)) &&& (is_even pred_n (!! true)))))
  let rec is_even_true n =
    (n === (!! O)) ||| (Fresh.one (fun not_res -> Fresh.one (fun pred_n -> (n === (!! (S (pred_n)))) &&& ((not_res === (!! false)) &&& (is_even pred_n (!! false))))))
